...
int main(int argc, char *argv[]){
    ...
    */
    ...
    constexpr Size ensembleSize = 100;
    ...
    const std::string rateName = "SIII" + to_stringWithPrecision(SI_II, 2) + "IS" + to_stringWithPrecision(I_S,2) + "D" + to_stringWithPrecision(diffusion, 2);
    ...
    for (unsigned ensemble=0; ensemble<ensembleSize; ++ensemble){
        ...
        SIS_meta::syncRun(network, rates, directory + "time_series.txt");
    }
